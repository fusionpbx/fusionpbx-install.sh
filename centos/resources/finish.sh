...
echo ""
echo "      Location          Vancouver Washington (available online)"
echo "      Admin Training    22 - 24 May 2018 (3 Days)"
echo "      Advanced Training To Be Determined"
echo "      Timezone: https://www.timeanddate.com/weather/usa/los-angeles"
echo ""
